...
clean:
	-rm client client.o client_game_tools.o nim_protocol_tools.o socket_IO_tools.o Nim_game.o utils.o Game_server.o

client: client.o client_game_tools.o nim_protocol_tools.o socket_IO_tools.o
	gcc -o $@ $^ $(FLAGS)

server: Game_server.o socket_IO_tools.o nim_protocol_tools.o Nim_game.o utils.o
	gcc -o $@ $^ $(FLAGS)
...
Game_server.o: Game_server.c Game_server.h socket_IO_tools.h nim_protocol_tools.h Nim_game.h utils.h
	gcc -c $*.c $(FLAGS)
